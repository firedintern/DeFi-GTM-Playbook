---
protocol: EigenCloud (EigenLayer)
category: Restaking
tvl_snapshot: "$4.8B (July 2026 DeFiLlama)"
gtm_archetype: Category creation
main_channels: LRT issuers; AVS ecosystem
incentive_style: Points-before-token; deposit caps
---

# EigenCloud (EigenLayer): Category Creation as GTM

## Founding wedge

EigenLayer invented "restaking": staked ETH re-pledged to secure additional services (AVSs), letting new networks rent Ethereum's security. The GTM began as an academic artifact. Sreeram Kannan's whitepaper and university credibility created a narrative category before a single deposit, backed by a16z's $100M (verified).
...
Supply side: **LRT issuers and LSTs**. That was the real acquisition surface; most restakers never touched EigenLayer directly. Demand side: **AVS ecosystem BD**. Every AVS launch recruited its own community into the EigenLayer economy.
...
- Creating the category means owning its vocabulary. Every "restaking" conversation marketed EigenLayer.
- Points that other protocols can build products on turn your incentive program into an economy.
- Narrative-driven TVL is fast in and fast out. The platform pivot is the tell that incentives bought attention, not retention.

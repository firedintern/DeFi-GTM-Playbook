...
Two tracks. **Track 1, DeFi-native composability**: money markets, DEX pools, yield aggregators and structured products holding stETH/wstETH as inventory. **Track 2, regulated custody workflows**: Lido V3 "stVaults" (mainnet early 2026) for institutions, ETFs and custodians (day-one users included Linea and Nansen; WisdomTree launched an ETP; VanEck/Northstake are building regulated ETF infrastructure after the SEC's 2025 staff statement that liquid staking tokens are not securities, staff guidance rather than a formal Commission ruling), and the July 2026 Anchorage Digital integration letting institutions mint and redeem wstETH without leaving regulated custody (verified: Lido blog, The Block).

The Anchorage pathway shows the product didn't change; the access path did. The channel is the custody workflow itself, which makes Lido the leading example of the "institutionalization = distribution upgrade" pattern (see [synthesis](../15-synthesis.md)). The regulatory clarity was itself a GTM enabler: the SEC's LST guidance did more than remove a constraint. It created the ETP/ETF/stVaults channel Lido then productized.

...
|---|---|---|---|---|
| [Aave](protocols/aave.md) | Lending | $23.3B | Product innovation + embedded distribution | Pivot from P2P; wallet/fintech integrations |
| [Lido](protocols/lido.md) | Liquid staking | $16.0B | Liquidity-first + integrations | Subsidized Curve stETH/ETH pool |
| [Morpho](protocols/morpho.md) | Lending infra | $10.8B | B2B "DeFi mullet" | Powering Coinbase loans; curator ecosystem |
| [Sky (MakerDAO)](protocols/sky-maker.md) | Stablecoin (CDP) | $6.6B | Default-asset network effects | DSR yield pass-through; Endgame subDAOs |
| [Spark](protocols/spark.md) | Capital allocator | $6.3B | Parent-capital seeding | Sky liquidity; Ignition airdrop |
| [EigenCloud](protocols/eigencloud.md) | Restaking | $4.8B | Category creation + points | Deposit caps; LRTs as salesforce |
| [Ethena](protocols/ethena.md) | Synthetic dollar | $4.7B | Points + CEX distribution | Shards/Sats campaigns; native yield |
| [Maple Finance](protocols/maple-finance.md) | Institutional credit | $4.1B | Institution-first, then retail wrapper | Pool delegates; revenue-funded buybacks |
| [JustLend](protocols/justlend.md) | Lending (Tron) | $3.5B | Ecosystem-default status | Official Tron lender; energy rental |
